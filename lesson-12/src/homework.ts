...
import { Modifiers } from "./interfaces/modifiers.js"
...
export class ObjectManipulator implements Modifiers{
    ...
    public set(key: string, value : any) : Modifiers {
        return new ObjectManipulator({...this.obj, [key]: value});
    }

    public get(key: string) : Modifiers {
        return this.obj[key];
    }

    public delete(key: string) : Modifiers {
